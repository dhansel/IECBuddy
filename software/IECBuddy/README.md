...
If you would like to compile the firmware from source then follow these steps:
  ...
  3) In the Tools->Board menu, select the "Waveshare RP2040-One" board (or Raspberry Pi Pico 1 or 2 for the Max variant).
  ...
  7) If your build should support the ST7789 display then un-comment the PIN_ST7789_* defines. In that case you
  ...
  8) Plug in your RP2040-One or Pi Pico board and click the "upload" button in the Arduino IDE.
